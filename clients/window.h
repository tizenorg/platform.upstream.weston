...
typedef void (*widget_touch_motion_handler_t)(struct widget *widget,
					      ...
					      wl_fixed_t y_w,
					      void *data);
typedef void (*widget_touch_frame_handler_t)(struct widget *widget, struct input *input, void *data);
typedef void (*widget_touch_cancel_handler_t)(struct widget *widget, struct input *input, void *data);
