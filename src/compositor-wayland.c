...
static void
input_hande_touch_down(void *data, struct wl_touch *wl_touch,
...
static void
input_hande_touch_up(void *data, struct wl_touch *wl_touch,
...
static void
input_hande_touch_motion(void *data, struct wl_touch *wl_touch,
...
static void
input_hande_touch_frame(void *data, struct wl_touch *wl_touch)
{
	struct wayland_input *input = data;
...
static void
input_hande_touch_cancel(void *data, struct wl_touch *wl_touch)
{
}

static const struct wl_touch_listener touch_listener = {
		input_hande_touch_down,
		input_hande_touch_up,
		input_hande_touch_motion,
		input_hande_touch_frame,
		input_hande_touch_cancel,
};
